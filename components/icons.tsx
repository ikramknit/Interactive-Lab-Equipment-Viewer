...
export const LabIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg 
    ...
    {...props}
  >
    <path d="M18.783 13.198l-5.463-8.21a1 1 0 00-1.64 0l-5.463 8.21C4.94 14.636 5.89 16 7.32 16h9.36c1.43 0 2.38-1.364 1.103-2.802zM12 18a4 4 0 00-4 4h8a4 4 0 00-4-4z"></path>
  </svg>
);
